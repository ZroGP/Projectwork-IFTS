...
const ASSETS_MALE = [
	...
	# --- Consoles ---
	{
		"id": "console_gray_2", "name": "Gray", "cost": 150, "category": "Consoles",
	...
	{
		"id": "console_white_2", "name": "White", "cost": 150, "category": "Consoles",
	...
	# --- PCs ---
	{
		"id": "pc_grey_2", "name": "Grey", "cost": 500, "category": "PCs",
	...
	{
		"id": "pc_white_2", "name": "White", "cost": 500, "category": "PCs",
	...
	# --- Specials ---
	{
		"id": "punchin_bag_red", "name": "Red", "cost": 110, "category": "Specials",
	...
	{
		"id": "punchin_bag_black", "name": "Black", "cost": 110, "category": "Specials",
...
const ASSETS_FEMALE = [
	...
	# --- Consoles ---
	{
		"id": "f_console_gray_1", "name": "Gray", "cost": 150, "category": "Consoles",
	...
	{
		"id": "f_console_white_1", "name": "White", "cost": 150, "category": "Consoles",
	...
	# --- PCs ---
	{
		"id": "f_pc_grey_1", "name": "Grey", "cost": 500, "category": "PCs",
	...
	{
		"id": "f_pc_white_1", "name": "White", "cost": 500, "category": "PCs",
	...
	# --- Windows ---
	{
		"id": "f_widow_1", "name": "Small", "cost": 150, "category": "Windows",
		"icon": "res://assets/room/windows/window1.png",
		"scene": "res://scenes/room/windows/window1.tscn",
		"position": Vector2(480, -204), "z": 0
	},
	{
		"id": "f_widow_2", "name": "Standard", "cost": 200, "category": "Windows",
		"icon": "res://assets/room/windows/window2.png",
		"scene": "res://scenes/room/windows/window2.tscn",
		"position": Vector2(520, -189), "z": 0
	},
	{
		"id": "f_widow_3", "name": "Classy", "cost": 200, "category": "Windows",
		"icon": "res://assets/room/windows/window3.png",
		"scene": "res://scenes/room/windows/window3.tscn",
		"position": Vector2(520, -189), "z": 0
	},
...
func _fill_panel(cat: String) -> void:
	...
	for asset in ASSETS:
		...
		var is_locked = not _is_unlocked(asset)

		if is_placed:
			icon_btn.modulate = Color(1, 1, 1, 0.4)
			icon_btn.disabled = true
		elif is_locked:
			icon_btn.modulate = Color(0.4, 0.4, 0.4, 0.6)
			icon_btn.disabled = true
		else:
		...
		_apply_font(name_lbl, is_placed or is_locked)
		info.add_child(name_lbl)

		var price_lbl = Label.new()
		price_lbl.text = "%d coins" % asset["cost"]
		_apply_font(price_lbl, is_placed or is_locked)
		info.add_child(price_lbl)

		if is_locked:
			var lock_lbl = Label.new()
			lock_lbl.text = "Needs: " + asset.get("requires", "")
			_apply_font(lock_lbl, true)
...
func _is_unlocked(asset: Dictionary) -> bool:
	var req = asset.get("requires", "")
	if req == "":
		return true
	return req in _placed.values()
